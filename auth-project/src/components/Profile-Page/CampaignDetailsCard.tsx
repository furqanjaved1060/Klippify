...
const CampaignDetailsCard = () => {
    ...
    return (
        ...
        <div className="w-fit xxs:w-full m-auto mb-3 bg-[#F9F9F9] p-3 grid xxs:grid-cols-[repeat(2,minmax(0,max-content))] gap-5 sm:grid-cols-[repeat(auto-fit,minmax(0,max-content))] justify-center xxs:justify-between items-center rounded-lg">
