...
const AuthHeader = () => {
    ...
    <header>
        <nav className='flex flex-row items-center gap-8 justify-between'>
            <Link to='/signin' className='text-sm font-medium flex items-center gap-1'><img src={flavicon} alt="" className='size-4' />Klippify</Link>
            ...
            <div>
                ...
                <Link to='/' className='ml-2 text-xxs text-[#007EFF] font-semibold underline'>Sign In</Link>
            </div>
            }
        </nav>
    </header>
