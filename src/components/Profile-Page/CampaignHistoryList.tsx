...
const CampaignHistoryList = () => {
    ...
    return (
        <ul className='space-y-3'>
            {campaigns.map((curCampaign) => {

                const {campaignName, rating, brandName, clicks, totalViews, earnings} = curCampaign;
                return (
                    <li className='p-2 border-1 border-[#D9D9D9] rounded-lg space-y-3'>
                        ...
                        <div className='flex flex-col sm:flex-row items-center justify-between gap-4'>
                            ...
                            <div className='flex flex-col xxs:flex-row items-center gap-2 xxs:gap-8 xs:gap-10 md:gap-20 lg:gap-25'>
                                <p className='flex items-center gap-2'><span className='text-sm font-semibold leading-none'>{clicks}</span><span className='text-xxs font-normal leading-none font-roboto'>Clicks</span></p>
                                <p className='flex items-center gap-2'><span className='text-sm font-semibold leading-none'>{totalViews}</span><span className='text-xxs font-normal leading-none font-roboto'>Total Views</span></p>
                                <p className='flex items-center gap-2'><span className='text-sm font-semibold leading-none'>{earnings}</span><span className='text-xxs font-normal leading-none font-roboto'>Earnings</span></p>
                            </div>
                        </div>
                    </li>
                )
